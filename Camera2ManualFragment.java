...
package com.example.android.android_camera2_manual;
...
public class Camera2BasicFragment extends Fragment
        implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback, SeekBar.OnSeekBarChangeListener, TextWatcher {
...
//        view.findViewById(R.id.info).setOnClickListener(this);
        ...
        seekBar_iso  = (SeekBar) view.findViewById(R.id.seekBar);
        ...
        seekBar_focus = (SeekBar) view.findViewById(R.id.focusSeek);
        seekBar_focus.setMax(100);
        seekBar_focus.setProgress(0);
        seekBar_focus.setOnSeekBarChangeListener(this);

        textISO = (TextView) view.findViewById(R.id.textISO);
        textFOCUS = (TextView) view.findViewById(R.id.textFOCUS);
        textSS = (TextView) view.findViewById(R.id.textSS);

        textISO.addTextChangedListener(this);
        textFOCUS.addTextChangedListener(this);
        textSS.addTextChangedListener(this);
    }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                int[] temp = characteristics.get(CameraCharacteristics.REQUEST_AVAILABLE_CAPABILITIES);

				//[9516, 234324552]
                Log.e("DEBUG", "Sensor Exposure time: "+characteristics.get(CameraCharacteristics.SENSOR_INFO_EXPOSURE_TIME_RANGE));
                //minFocus = characteristics.get(CameraCharacteristics.LENS_INFO_MINIMUM_FOCUS_DISTANCE);
                //Toast.makeText(this.getActivity(), minFocus+"", Toast.LENGTH_SHORT).show();
                /*minFocus = characteristics.get(CameraCharacteristics.LENS_INFO_HYPERFOCAL_DISTANCE);
                Toast.makeText(this.getActivity(), minFocus+" hyperfocal", Toast.LENGTH_SHORT).show();*/
